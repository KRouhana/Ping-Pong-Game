...
/**
*	This interface defines the set of global constants used by all classes.
*	@author ferrie
*	 */
public class ppSimParams {
 	...
 	// 2. Parameters defined in simulation coordinates (MKS, x-->range, y-->height)
 	    ...
 	    static final double Pi = 3.1416;						//Pi	 	 	
 		...
 		static final Color ColorTrace = Color.black;
...
// 4. Miscellaneous
 	    ...
 	    static final boolean DEBUG = false;  	 				// if true	 	 	// Enable debug messages and single step 
